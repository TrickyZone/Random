...
class dev_profile(models.Model):
    limits =2
    ...
    position1 = models.CharField(choices=position_choice, max_length=50, blank=True, default=1)
    position2 = models.CharField(choices=position_choice, max_length=50, blank=True, default=1)
    position3 = models.CharField(choices=position_choice, max_length=50, blank=True, default=1)
    position4 = models.CharField(choices=position_choice, max_length=50, blank=True, default=1)
    def __str__(self):
        return self.title 
